...
#include "SDKMinimalClient_modified.hpp"
...
// ... 这里省略原有的RegisterAllCallbacks、Run、PrintRawSkeletonNodeInfo、Connect函数
// 这些函数保持不变，只需确保头文件包含新增的成员函数即可